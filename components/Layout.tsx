...
const Layout: React.FC<LayoutProps> = ({ children, activePage, onNavigate }) => {
  ...
  const mainMenuItems = [
    ...
    { id: 'attendance-management', label: 'จัดการลงเวลา', icon: CalendarClock, roles: [UserRole.ADMIN, UserRole.OFFICE_MANAGER] },
  ...
  const configMenuItems = [
    // CRITICAL: จำกัดให้เฉพาะ ADMIN เท่านั้นที่เห็นส่วนการตั้งค่าโครงสร้างหลัก
